...
team performance in a 20-minute ergometer relay (one ergometer per team,
rowers taking turns).
"""
...
# and achieved different total relay distances in 20 minutes
team_configs = {
    'Team_1': {'n_men': 3, 'n_women': 2, 'distance_m': 6319},
    'Team_2': {'n_men': 0, 'n_women': 5, 'distance_m': 5819},
    'Team_3': {'n_men': 2, 'n_women': 3, 'distance_m': 5530},
    'Team_4': {'n_men': 3, 'n_women': 2, 'distance_m': 6235},
    'Team_5': {'n_men': 2, 'n_women': 3, 'distance_m': 5084},
    'Team_6': {'n_men': 1, 'n_women': 4, 'distance_m': 5253},
    'Team_7': {'n_men': 0, 'n_women': 4, 'distance_m': 5100}
}

# Create normalizer with default reference powers
# Men: 569.92 W (5:40 for 2K)
# Women: 350.00 W (6:40 for 2K)
normalizer = ERGNormalizer(duration_s=20 * 60)
...
normalizer2.add_team('Alpha Squad', n_men=2, n_women=2, distance_m=5500)
normalizer2.add_team('Beta Crew', n_men=3, n_women=1, distance_m=5800)
...
normalizer3.add_teams_from_dict({
    'Team_Masters_1': {'n_men': 3, 'n_women': 2, 'distance_m': 5900},
    'Team_Masters_2': {'n_men': 2, 'n_women': 3, 'distance_m': 5400}
})
